...
class SimplifiedParallelDemo {
     ...
     */
    async demoMathOptimization(): Promise<void> {
        console.log('\n🔬 Demo 1: Mathematical Function Optimization');
        console.log('='.repeat(50));

        // Sphere function optimization
        const sphereFunction = (params: any) => {
            const { x, y } = params;
     ...
     */
    async demoTradingOptimization(): Promise<void> {
        console.log('\n📈 Demo 2: Trading Strategy Optimization');
        console.log('='.repeat(50));

        // RSI trading strategy
        const rsiStrategy = (params: any) => {
     ...
     */
    async demoPerformanceScaling(): Promise<void> {
        console.log('\n⚡ Demo 3: Performance Scaling Analysis');
        console.log('='.repeat(50));

        // Complex optimization problem
        const complexFunction = (params: any) => {
            const { x, y, z } = params;
    ...
    async demoAlgorithmComparison(): Promise<void> {
        ...
        const rastriginFunction = (params: any) => {
            const { x, y } = params;
            const A = 10;
            const n = 2;
     ...
     */
    async demoResourceMonitoring(): Promise<void> {
        ...
        const monitoredFunction = (params: any) => {
        ...
        try {
            await this.parallelManager.runParallelOptimization(
                monitoredFunction,
                monitoredSpace,
                {
                    algorithm: 'random',
