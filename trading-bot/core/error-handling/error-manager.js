...
exports.errorManager = exports.AdvancedErrorManager = exports.ErrorSeverity = exports.ErrorType = void 0;
...
(function (ErrorType) {
    ...
    ErrorType["STRATEGY_EXECUTION"] = "STRATEGY_EXECUTION";
    ErrorType["OPTIMIZATION_FAILURE"] = "OPTIMIZATION_FAILURE";
    ErrorType["SYSTEM_RESOURCE"] = "SYSTEM_RESOURCE";
    ErrorType["MARKET_DATA_ERROR"] = "MARKET_DATA_ERROR";
...
// ============================================================================
class AdvancedErrorManager extends events_1.EventEmitter {
    constructor() {
        super();
        this.errors = new Map();
     ...
     */
    async executeWithRetry(operation, errorType, context = {}, component) {
    ...
    getRecentErrors(type, timeWindow) {
        ...
        return Array.from(this.errors.values()).filter(error => error.type === type && error.timestamp > cutoff);
    }
    /**
    ...
    isCircuitBreakerClosed(component) {
        const breaker = this.circuitBreakers.get(component);
        if (!breaker)
            return true;
    ...
    getErrorStats() {
        ...
        return {
            ...
            byType,
            bySeverity,
            circuitBreakers: Object.fromEntries(Array.from(this.circuitBreakers.entries()).map(([key, value]) => [
                key,
    ...
    getCircuitBreakerStatus() {
        return Object.fromEntries(Array.from(this.circuitBreakers.entries()).map(([key, value]) => [
            key,
            {
                state: value.state,
...
exports.AdvancedErrorManager = AdvancedErrorManager;
// Export singleton instance
exports.errorManager = new AdvancedErrorManager();
