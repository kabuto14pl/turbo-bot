...
} from './complex_objective_functions';
...
class ComplexObjectiveDemo {
    private objectiveManager: ObjectiveFunctionManager;
    private marketDetector: MarketConditionDetector;
    private perfCalculator: PerformanceCalculator;

    constructor() {
        this.objectiveManager = new ObjectiveFunctionManager();
     ...
     */
    async demoBasicObjectiveFunctions(): Promise<void> {
        ...
        for (const configName of configs) {
            ...
            const evaluation = await this.objectiveManager.evaluateStrategy(
                configName,
                performanceData
            );
    ...
    async demoCustomObjectiveFunctions(): Promise<void> {
        ...
        const hftObjective: ObjectiveConfiguration = {
            ...
            components: [
                ...
                {
                    type: ObjectiveComponentType.TRANSACTION_COSTS,
                ...
                {
                    type: ObjectiveComponentType.MARKET_IMPACT,
                    name: 'market_impact',
                    weight: 0.20,
     ...
     */
    async demoMarketAdaptiveObjectives(): Promise<void> {
        console.log('\n🌍 Demo 3: Market-Adaptive Objective Functions');
        console.log('='.repeat(60));

        // Stwórz adaptacyjną funkcję celu
        const adaptiveObjective: ObjectiveConfiguration = {
            ...
            components: [
                ...
                {
                    type: ObjectiveComponentType.ROBUSTNESS,
                    name: 'robustness',
                    weight: 0.1
                }
            ],
            ...
            marketAdaptation: {
                ...
                conditions: {
                    ...
                    [MarketCondition.HIGH_VOLATILITY]: {
                        ...
                        aggregationStrategy: AggregationStrategy.HARMONIC_MEAN
                    },
                    ...
                    [MarketCondition.SIDEWAYS]: {
                        ...
                        aggregationStrategy: AggregationStrategy.GEOMETRIC_MEAN
                    },
     ...
     */
    async demoAggregationStrategies(): Promise<void> {
        ...
        const baseComponents: any[] = [
            ...
            },
            {
                ...
                name: 'risk',
                weight: 0.3,
                transformation: { type: 'linear' as const, parameters: { a: -1, b: 0 } }
            },
            {
                type: ObjectiveComponentType.STABILITY,
                name: 'stability',
     ...
     */
    async demoSensitivityAnalysis(): Promise<void> {
     ...
     */
    private generateTestPerformanceData(scenario: string): StrategyPerformanceData {
