 ...
 */
export const MA_CROSSOVER_SPACE: HyperparameterSpace = {
    name: 'ma_crossover',
 ...
 */
export const RSI_STRATEGY_SPACE: HyperparameterSpace = {
    name: 'rsi_strategy',
 ...
 */
export const BOLLINGER_BANDS_SPACE: HyperparameterSpace = {
 ...
 */
export const MACD_STRATEGY_SPACE: HyperparameterSpace = {
    name: 'macd_strategy',
 ...
 */
export const MULTI_TIMEFRAME_SPACE: HyperparameterSpace = {
...
export class SpaceBuilder {
    private space: Partial<HyperparameterSpace>;
    
    constructor(name: string, strategyType: string) {
        this.space = {
            name,
            strategyType,
            version: '1.0.0',
    ...
    description(desc: string): SpaceBuilder {
        this.space.description = desc;
        return this;
    }

    addIntegerParam(name: string, min: number, max: number, options?: Partial<ParameterDefinition>): SpaceBuilder {
    ...
    addFloatParam(name: string, min: number, max: number, options?: Partial<ParameterDefinition>): SpaceBuilder {
        const param: ParameterDefinition = {
            name,
            type: ParameterType.FLOAT,
            min,
    ...
    addCategoricalParam(name: string, choices: any[], options?: Partial<ParameterDefinition>): SpaceBuilder {
        const param: ParameterDefinition = {
            name,
            type: ParameterType.CATEGORICAL,
            choices,
    ...
    addBooleanParam(name: string, options?: Partial<ParameterDefinition>): SpaceBuilder {
        const param: ParameterDefinition = {
            name,
            type: ParameterType.BOOLEAN,
            ...options
    ...
    addConstraint(name: string, expression: string, parameters: string[]): SpaceBuilder {
    ...
    build(): HyperparameterSpace {
        ...
        return this.space as HyperparameterSpace;
    }
}
...
export function initializePredefinedSpaces(): void {
    ...
    for (const space of spaces) {
        try {
            hyperparameterSpaceManager.createSpace(space);
            initializedCount++;
        } catch (error) {
 ...
 */
export function createCustomSpace(): HyperparameterSpace {
