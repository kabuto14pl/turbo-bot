...
exports.AlertStatus = exports.AlertSeverity = exports.AlertingSystem = void 0;
...
class AlertingSystem extends events_1.EventEmitter {
    ...
    setupDefaultRules() {
        ...
        this.addRule({
            id: 'high_loss_rate',
            name: 'High Loss Rate',
            condition: (value) => value < 30, // Win rate below 30%
        ...
        this.addRule({
            ...
            condition: (value) => value < -5000, // Daily loss > $5000
        ...
        this.addRule({
            ...
            condition: (value) => value > 5, // Errors per minute > 5
            severity: AlertSeverity.HIGH,
    ...
    checkMetric(metricName, value, source = 'system') {
    ...
    shouldCheckRule(rule, metricName) {
        // Map metrics to rules
        const metricRuleMapping = {
    ...
    triggerAlert(rule, value, source) {
