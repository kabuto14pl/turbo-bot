...
async function main() {
    try {
        ...
        fs.writeFileSync(path.join(resultsDir, 'RSITurbo_trades.json'), JSON.stringify(results.trades, null, 2));
        fs.writeFileSync(path.join(resultsDir, 'RSITurbo_signals.json'), JSON.stringify(results.signals, null, 2));
        fs.writeFileSync(path.join(resultsDir, 'RSITurbo_stats.json'), JSON.stringify(results.stats, null, 2));
        // Zapisz informacje o parametrach
        fs.writeFileSync(path.join(resultsDir, 'RSITurbo_params.json'), JSON.stringify(rsiParams, null, 2));
        // Drukuj wyniki
