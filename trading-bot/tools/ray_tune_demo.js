 ...
 */
async function testObjectiveFunction(params) {
 ...
 */
async function demoRayTuneOptimization() {
    console.log('🚀 Rozpoczynam demonstrację optymalizacji z Ray Tune');
    // Konfiguracja eksperymentu
    const optimizer = new ray_tune_optimizer_1.RayTuneOptimizer({
 ...
 */
async function demoRayTunePython() {
    ...
    try {
        ...
        const results = await optimizer.optimizeWithPython(objectiveScriptPath, parameterSpace, { param_a: 5, param_b: 5 } // Dodatkowe parametry
        );
        // Wyświetl wyniki
        console.log('✅ Optymalizacja zakończona pomyślnie!');
        console.log(`Najlepszy wynik: ${results.bestScore}`);
