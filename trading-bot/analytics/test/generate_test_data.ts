...
class TestDataGenerator {
    ...
    private readonly strategies = ['RSITurbo'];
    private readonly timeframes = ['m15'];
    ...
    private readonly MAX_UPDATES = 10;
    private isShuttingDown = false;

    constructor() {
        this.logger = new Logger();
        this.metricsServer = new MetricsServer(9090, this.logger);
    }
