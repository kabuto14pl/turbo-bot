...
exports.ProductionConfigValidator = exports.HIGH_PERFORMANCE_PRODUCTION_CONFIG = exports.MINIMAL_PRODUCTION_CONFIG = exports.DEFAULT_PRODUCTION_CONFIG = void 0;
exports.DEFAULT_PRODUCTION_CONFIG = {
 ...
 */
exports.HIGH_PERFORMANCE_PRODUCTION_CONFIG = {
    ...exports.DEFAULT_PRODUCTION_CONFIG,
    ...
    performanceConfig: {
        ...exports.DEFAULT_PRODUCTION_CONFIG.performanceConfig,
    ...
    productionParams: {
        ...exports.DEFAULT_PRODUCTION_CONFIG.productionParams,
...
class ProductionConfigValidator {
    static validateForLiveTrading(config) {
        const errors = [];
    ...
    static requiresManualConfirmation(config) {
