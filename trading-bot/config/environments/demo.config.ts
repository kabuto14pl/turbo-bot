...
import { DemoConfig } from './base.config';
...
export const CONSERVATIVE_DEMO_CONFIG: DemoConfig = {
  ...
  demoParams: {
    ...DEFAULT_DEMO_CONFIG.demoParams,
 ...
 */
export const AGGRESSIVE_DEMO_CONFIG: DemoConfig = {
  ...DEFAULT_DEMO_CONFIG,
  ...
  loggingConfig: {
    ...DEFAULT_DEMO_CONFIG.loggingConfig,
