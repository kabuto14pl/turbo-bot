...
exports.riskProfileManager = exports.RiskProfileManager = exports.RISK_PROFILE_REGISTRY = exports.AGGRESSIVE_RISK_PROFILE = exports.MODERATE_RISK_PROFILE = exports.CONSERVATIVE_RISK_PROFILE = exports.ULTRA_CONSERVATIVE_RISK_PROFILE = void 0;
/**
 * Ultra Conservative Risk Profile
 * For new traders or minimal risk tolerance
 */
exports.ULTRA_CONSERVATIVE_RISK_PROFILE = {
 ...
 */
exports.RISK_PROFILE_REGISTRY = {
    'ultra_conservative': exports.ULTRA_CONSERVATIVE_RISK_PROFILE,
...
class RiskProfileManager {
    ...
    getRiskProfile(profileName) {
        return exports.RISK_PROFILE_REGISTRY[profileName] || null;
    }
    /**
     ...
     */
    calculatePositionSize(portfolioValue, entryPrice, stopLoss, confidence = 1.0) {
     ...
     */
    validateTrade(tradeRisk, currentDrawdown) {
        if (!this.currentProfile)
            return false;
        const profile = this.currentProfile;
    ...
    generateRiskSummary() {
        if (!this.currentProfile)
            return 'No risk profile selected';
        const profile = this.currentProfile;
        return `
...
exports.RiskProfileManager = RiskProfileManager;
// Singleton instance export
exports.riskProfileManager = RiskProfileManager.getInstance();
