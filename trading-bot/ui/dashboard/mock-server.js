...
app.get('/api/trades', (req, res) => {
    ...
    res.json(mockTrades.slice(0, parseInt(limit)));
});
// Strategy endpoints
...
app.get('/api/market/prices', (req, res) => {
    ...
    if (symbols) {
        ...
        const filteredPrices = Object.fromEntries(Object.entries(mockPrices).filter(([symbol]) => requestedSymbols.includes(symbol)));
