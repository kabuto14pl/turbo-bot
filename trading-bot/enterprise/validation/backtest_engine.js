...
exports.EnterpriseBacktestEngine = void 0;
...
class EnterpriseBacktestEngine {
    constructor() {
        ...
        this.resultsDir = (0, path_1.join)(__dirname, '../../results/backtests');
     ...
     */
    async executeComprehensiveBacktest(config) {
     ...
     */
    async loadAndValidateData(config) {
     ...
     */
    async executeBacktest(data, config, testType) {
     ...
     */
    calculateMetrics(trades, equityCurve, config, testType, executionData) {
     ...
     */
    detectOverfitting(inSample, outOfSample) {
    ...
    async loadFromBinance(symbol, start, end) {
    ...
    splitDataForTesting(data, outOfSampleRatio) {
    ...
    generateTradingSignal(data, index, strategy) {
    ...
    simulateOrderExecution(candle, signal, config) {
    ...
    async generateBacktestReport(inSample, outOfSample, overfitting, config) {
        const report = {
            timestamp: new Date().toISOString(),
            config,
            results: {
        ...
        const filePath = (0, path_1.join)(this.resultsDir, fileName);
...
exports.EnterpriseBacktestEngine = EnterpriseBacktestEngine;
exports.default = EnterpriseBacktestEngine;
