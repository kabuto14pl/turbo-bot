...
const performance_monitor_1 = __importDefault(require("./performance_monitor"));
const resource_limiter_1 = __importDefault(require("./core/optimization/resource_limiter"));
const performance_cache_manager_1 = __importDefault(require("./core/cache/performance_cache_manager"));
const worker_thread_manager_1 = __importDefault(require("./core/workers/worker_thread_manager"));
class OptimizedBotRunner {
    async start() {
        ...
        try {
            ...
            this.performanceMonitor = new performance_monitor_1.default();
            ...
            this.resourceLimiter = new resource_limiter_1.default();
            // 3. Initialize Cache Manager (if Redis available)
            console.log('🗃️ Initializing cache manager...');
            this.cacheManager = new performance_cache_manager_1.default({
                redis: {
                    host: 'localhost',
                    port: 6379,
                    db: 0
            ...
            this.workerManager = new worker_thread_manager_1.default(1); // Only 1 worker for i3
...
exports.default = OptimizedBotRunner;
