...
const MTF_SL_ATR = 1.2;               // P#237: SL distance in ATR units (was 2.0 — too wide per board review)
const MTF_TP_ATR = 3.0;               // P#237: TP distance in ATR units (was 5.0 — rarely reached)
