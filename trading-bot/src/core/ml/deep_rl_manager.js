...
exports.DeepRLManager = exports.DEFAULT_DEEP_RL_CONFIG = void 0;
const deep_rl_agent_1 = require("./deep_rl_agent");
const logger_1 = require("../../../core/utils/logger");
exports.DEFAULT_DEEP_RL_CONFIG = {
    enabled: true,
    trainingMode: true,
...
class DeepRLManager {
    constructor(config = {}) {
        ...
        this.config = { ...exports.DEFAULT_DEEP_RL_CONFIG, ...config };
    ...
    initializeAgent() {
        try {
            ...
            this.agent = (0, deep_rl_agent_1.createBalancedAgent)();
     ...
     */
    async processStep(price, rsi, volume, additionalData = {}) {
     ...
     */
    async learnFromResult(price, rsi, volume, tradeResult) {
        try {
     ...
     */
    createMarketState(price, rsi, volume, additionalData = {}) {
        const now = Date.now();
     ...
     */
    applyRiskManagement(action) {
        const filteredAction = { ...action };
        // Limit position size
        filteredAction.position_size = Math.max(-this.config.maxPositionSize, Math.min(this.config.maxPositionSize, filteredAction.position_size));
    ...
    checkEmergencyConditions() {
        ...
        if (this.dailyPnL < -this.config.maxDailyLoss * 2 || // Extreme daily loss
...
exports.DeepRLManager = DeepRLManager;
