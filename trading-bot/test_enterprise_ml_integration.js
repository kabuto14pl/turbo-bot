...
exports.testEnterpriseMLIntegration = testEnterpriseMLIntegration;
exports.testProductionDeploymentReadiness = testProductionDeploymentReadiness;
...
async function testEnterpriseMLIntegration() {
    ...
    try {
        ...
        const mlManager = new simple_rl_adapter_1.SimpleRLAdapter({
            enabled: true,
            training_mode: true,
            algorithm: 'PPO'
        });
        ...
        await mlManager.learnFromResult(100, // PnL
