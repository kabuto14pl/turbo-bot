...
exports.DashboardAPIServer = void 0;
/**
...
class DashboardAPIServer {
    ...
    setupRoutes() {
        ...
        this.app.get('/api/portfolio/history', (req, res) => {
            ...
            const mockHistory = this.generateMockPortfolioHistory(timeframe);
        ...
        this.app.get('/api/market/data', (req, res) => {
            const symbols = req.query.symbols || ['BTC/USDT', 'ETH/USDT', 'BNB/USDT'];
    ...
    generateMockPortfolioHistory(timeframe) {
...
exports.DashboardAPIServer = DashboardAPIServer;
