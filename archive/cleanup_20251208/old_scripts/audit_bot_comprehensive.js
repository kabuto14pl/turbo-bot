...
class BotAuditor {
    ...
    // ========================================================================
    async auditEnterpriseComponents() {
    ...
    async auditSecurity() {
        ...
        if (fs.existsSync(botFile)) {
            ...
            const hasHardcodedSecrets = content.match(/apiKey\s*=\s*["'][^"']{10,}["']/) ||
    ...
    generateReport() {
        ...
        const criticalFails = this.results.filter(r => r.status === 'FAIL' &&
            (r.category === 'Dependencies' || r.category === 'ML System' || r.category === 'Security')).length;
