 ...
 */
import { ProductionMLIntegrator } from './trading-bot/src/core/ml/production_ml_integrator';
...
async function testProductionMLIntegrator() {
    try {
        ...
        const mlIntegrator = new ProductionMLIntegrator({
