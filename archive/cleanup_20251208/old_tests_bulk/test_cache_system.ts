...
async function testCacheSystem() {
  ...
  try {
    ...
    const cacheService = CacheServiceFactory.createForTesting();
    const tradingCacheManager = new TradingCacheManager(cacheService, logger);
    ...
    const { CacheProvider } = await import('./trading-bot/core/cache/trading_cache_manager');
