...
async function runEnterpriseMLTest() {
    ...
    try {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            await performanceMonitor.endInferenceTracking(inferenceId, [Math.random() * 0.3 + 0.7], // predictions as number[]
        ...
        const monitoringInterval = setInterval(async () => {
            ...
            setTimeout(async () => {
                await performanceMonitor.endInferenceTracking(infId, [Math.random() * 0.4 + 0.6], // predictions as number[]
