...
exports.enterpriseMLProduction = exports.EnterpriseMLProductionIntegration = void 0;
const enterprise_ml_integration_manager_1 = require("./src/enterprise_ml_integration_manager");
const enterprise_ml_strategy_clean_1 = require("./trading-bot/strategies/enterprise_ml_strategy_clean");
const logger_1 = require("./trading-bot/infrastructure/logging/logger");
class EnterpriseMLProductionIntegration {
    constructor() {
    ...
    async initialize() {
        try {
            ...
            this.mlStrategy = new enterprise_ml_strategy_clean_1.EnterpriseMLStrategy(this.logger, {
     ...
     */
    async getTradingSignals(botState) {
    ...
    async getPerformanceMetrics() {
        ...
        try {
            ...
            // Check if method exists before calling
            if (typeof this.mlManager.getPerformanceMetrics === 'function') {
                return await this.mlManager.getPerformanceMetrics();
            }
            else {
    ...
    async shutdown() {
        try {
            ...
            if (this.mlManager) {
                ...
                if (typeof this.mlManager.shutdown === 'function') {
...
exports.EnterpriseMLProductionIntegration = EnterpriseMLProductionIntegration;
// Export singleton instance
exports.enterpriseMLProduction = new EnterpriseMLProductionIntegration();
/**
