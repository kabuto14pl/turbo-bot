...
exports.MLRetrainManager = void 0;
const events_1 = require("events");
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
class MLRetrainManager extends events_1.EventEmitter {
    constructor(config) {
        super();
        this.trade_count = 0;
        this.total_retrains = 0;
        this.last_retrain_at = 0;
        this.retrain_history = [];
        // Performance tracking
        this.recent_trades = [];
        this.pre_retrain_checkpoint = null;
        this.config = {
     ...
     */
    async performRetrain(mlAdapter) {
        console.log('\n🎓 ML RETRAIN STARTING...');
     ...
     */
    async capturePerformance(mlAdapter) {
     ...
     */
    async createCheckpoint(mlAdapter) {
     ...
     */
    async rollbackToCheckpoint(mlAdapter, checkpoint_path) {
     ...
     */
    async retrainModel(mlAdapter, trades) {
        ...
        for (const trade of trades) {
            ...
            // Learn from result
            await mlAdapter.learnFromResult(trade.pnl, trade.duration || 0, {
     ...
     */
    calculatePerformanceChange(before, after) {
...
exports.MLRetrainManager = MLRetrainManager;
