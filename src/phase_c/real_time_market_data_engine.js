...
class RealTimeMarketDataEngine extends events_1.EventEmitter {
    constructor() {
        ...
        const cacheService = new in_memory_cache_service_1.InMemoryCacheService(cacheConfig);
        this.dataCache = new trading_cache_manager_1.TradingCacheManager(cacheService);
        this.dataQuality = {
            uptime: 0,
            latency: 0,
            errorRate: 0,
