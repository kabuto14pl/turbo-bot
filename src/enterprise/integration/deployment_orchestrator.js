...
exports.ProductionDeploymentOrchestrator = void 0;
...
`;
    ...
    async startEnterpriseSystem() {
        console.log('[DEPLOYMENT] Starting Enterprise Trading Engine...');
        const startupScriptPath = path.join(process.cwd(), 'src/enterprise/integration/startup_orchestrator.ts');
        return new Promise((resolve, reject) => {
            const startupProcess = (0, child_process_1.spawn)('npx', ['ts-node', startupScriptPath], {
                stdio: 'pipe',
                detached: false
            });
            let startupTimeout;
...
exports.ProductionDeploymentOrchestrator = ProductionDeploymentOrchestrator;
