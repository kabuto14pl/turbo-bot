...
class MockAutonomousTradingBot extends EventEmitter {
...
class SimplifiedIntegrationTest {
    ...
    private async testTradingBotLifecycle(): Promise<void> {
    ...
    private async testSystemOrchestration(): Promise<void> {
...
export { SimplifiedIntegrationTest };
